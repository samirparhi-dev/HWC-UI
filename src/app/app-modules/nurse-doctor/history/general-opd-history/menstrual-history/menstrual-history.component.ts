...
export class MenstrualHistoryComponent implements OnInit, DoCheck {
  ...
  disableNoneMenstrualProblem: boolean = null;
  constructor(
  ...
  assignSelectedLanguage() {
    ...
    resetOtherMenstrualProblems() {
      let menstrualProblemList = this.menstrualHistoryForm.value.menstrualProblemList;
      let flag = false;
      ...
      menstrualProblemList.forEach(item => {
