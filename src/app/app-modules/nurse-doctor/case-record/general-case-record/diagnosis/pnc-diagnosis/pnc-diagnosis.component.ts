...
export class PncDiagnosisComponent implements OnInit, OnDestroy {
  ...
  addProvisionalDiagnosis() {
    let provisionalDiagnosisArrayList = this.generalDiagnosisForm.controls[
  ...
  handleProvisionalDiagnosisData(provisionalDiagnosisDataList) {
    let provisionalDiagnosisList = this.generalDiagnosisForm.controls[
      "provisionalDiagnosisList"
    ] as FormArray;
  ...
  handleConfirmatoryDiagnosisData(confirmatoryDiagnosisDataList) {
    let confirmatoryDiagnosisList = this.generalDiagnosisForm.controls[
  ...
  addConfirmatoryDiagnosis() {
    let confirmatoryDiagnosisArrayList = this.generalDiagnosisForm.controls[
      "confirmatoryDiagnosisList"
    ] as FormArray;
  ...
  removeConfirmatoryDiagnosis(index, confirmatoryDiagnosisForm) {
    let confirmatoryDiagnosisFormArrayList = this.generalDiagnosisForm.controls[
      "confirmatoryDiagnosisList"
    ] as FormArray;
