...
export class IdrsComponent implements OnInit, DoCheck {
  ...
  ngOnDestroy() {
    ...
    if (this.IDRSScoreFlagCheckSubscription) this.IDRSScoreFlagCheckSubscription.unsubscribe();
    if (this.visitDiseaseSubscription) this.visitDiseaseSubscription.unsubscribe();
    if (this.systolicBpValueSubscription) this.systolicBpValueSubscription.unsubscribe();
    if (this.diastolicBpValueSubscription) this.diastolicBpValueSubscription.unsubscribe();
    if (this.hypertensionSelectedFlagSubscription) this.hypertensionSelectedFlagSubscription.unsubscribe();
    // this.idrsScoreService.clearScoreFlag();
  ...
  getIDRSDetailsFrmNurse(visitID, benRegID) {
    this.IDRSDetailsSubscription = this.doctorService
      ...
      .subscribe((value) => {
        if (value !== null && value.statusCode === 200 && value.data !== null && value.data !== undefined) {
          this.doctorService.screeningType = "Idrs";
          if ((value.data.IDRSDetail !== undefined && value.data.IDRSDetail !== null &&
            ...
            if (value.data.IDRSDetail.suspectedDisease && 
              value.data.IDRSDetail.suspectedDisease !== undefined && 
              value.data.IDRSDetail.suspectedDisease !== null) {
          ...
          if(value.data.IDRSDetail !== undefined && 
            value.data.IDRSDetail !== null &&
            value.data.IDRSDetail.idrsDetails !== undefined &&
            value.data.IDRSDetail.idrsDetails !== null) {
