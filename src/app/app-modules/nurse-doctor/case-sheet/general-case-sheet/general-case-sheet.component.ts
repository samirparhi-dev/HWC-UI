  ...
  selectPrintPage() {
    ...
    mdDialogRef.afterClosed().subscribe(result => {
      if (result) {
        ...
        this.printPagePreviewSelect.caseSheetNCDScreeningDetails = result.caseSheetNCDScreeningDetails;
        this.printPagePreviewSelect.caseSheetFamilyPlanning = result.caseSheetFamilyPlanning;
        this.printPagePreviewSelect.caseSheetVisitDetails = result.caseSheetVisitDetails;
