...
//  this.registrarService.GenerateOTP$.subscribe(response => (response == true ? this.disableGenerateOTP = true : this.disableGenerateOTP = false));
  ...
  */
  resetBeneficiaryForm() {
    ...
    let personalFormReset = <FormGroup>this.beneficiaryRegistrationForm.controls['personalDetailsForm'];
    let date = new Date();
      ...
      .forEach(control => {
        ...
        if (!personalForm.controls[control].valid) {
          if (control == 'maritalStatus') {
            ...
            required.push(this.currentLanguageSet.ro.personalInfo.alternateNumber)
          }
    ...
    this.registrarService.submitBeneficiary(iEMRForm)
      .subscribe((res) => {
        if (res.statusCode == 200) {
          ...
          //   }
          // }
          let responseValue = res.data.response;
          let benId = responseValue.replace( /^\D+/g, '');
       ...
       this.disableGenerateOTP = false;
          ...
          let successRes = res.data.response+'\n'+ this.currentLanguageSet.proceedForFamilyTaggingProcess;

       
           
          this.confirmationService.confirm('success',successRes, 'Yes', 'No').subscribe((responseData) => {
            if (responseData) {
  ...
  */
  ...
  openSearchFamily(beneficiaryRegID,benSurname,benName,benDistrictId,benBlockId,benVillageId,beneficiaryId) {
    let mdDialogRef: MdDialogRef<SearchFamilyComponent> = this.dialog.open(
      SearchFamilyComponent,
      {
        ...
        width: "60%",
        disableClose: true,
        data : {"benSurname" : benSurname , "benDistrictId" : benDistrictId, "benBlockId" : benBlockId, "benVillageId" : benVillageId}
      }
    );
  ...
  getBeneficiaryDetailsForFamilyTagging(benId) {
  ...
  this.registrarService.identityQuickSearch(benReqObj).subscribe(
    (beneficiaryDetails) => {
      if (beneficiaryDetails && beneficiaryDetails.length == 1) {
         let beneficiaryRegID = (beneficiaryDetails[0].beneficiaryRegID !== undefined && beneficiaryDetails[0].beneficiaryRegID !== null) ? beneficiaryDetails[0].beneficiaryRegID : null ;
         let benSurname = (beneficiaryDetails[0].lastName !== undefined && beneficiaryDetails[0].lastName !== null) ? beneficiaryDetails[0].lastName : null ;
         let benName = (beneficiaryDetails[0].firstName !== undefined && beneficiaryDetails[0].firstName !== null) ? beneficiaryDetails[0].firstName : null;
         if(beneficiaryDetails[0].lastName !== undefined && beneficiaryDetails[0].lastName !== null && beneficiaryDetails[0].lastName !== "") {
              benName = benName + " " + beneficiaryDetails[0].lastName;
         }
         let benDistrictId = (beneficiaryDetails[0].i_bendemographics.districtID !== undefined && beneficiaryDetails[0].i_bendemographics.districtID !== null) ? beneficiaryDetails[0].i_bendemographics.districtID : null ;
         let benBlockId = (beneficiaryDetails[0].i_bendemographics.blockID !== undefined && beneficiaryDetails[0].i_bendemographics.blockID !== null) ? beneficiaryDetails[0].i_bendemographics.blockID : null ;
         let benVillageId = (beneficiaryDetails[0].i_bendemographics.districtBranchID !== undefined && beneficiaryDetails[0].i_bendemographics.districtBranchID !== null) ? beneficiaryDetails[0].i_bendemographics.districtBranchID : null ;
         let beneficiaryId = (beneficiaryDetails[0].beneficiaryID !== undefined && beneficiaryDetails[0].beneficiaryID !== null) ? beneficiaryDetails[0].beneficiaryID : null ;
         
         this.openSearchFamily(beneficiaryRegID,benSurname,benName,benDistrictId,benBlockId,benVillageId,beneficiaryId);
      }
  ...
  */
  ...
  getBenAlternatePhMapID(benAlternatePhMapID) {
...
else
{
  ...
  NavigateToFamilyTagging(){
    let benFullName = (this.revisitData.firstName !== undefined && this.revisitData.firstName !== null) ? this.revisitData.firstName : null;
    if(this.revisitData.lastName !== undefined && this.revisitData.lastName !== null && this.revisitData.lastName !== "") {
      benFullName = benFullName + " " + this.revisitData.lastName;
    }

    let reqObj={
      "beneficiaryRegID": this.revisitData.beneficiaryRegID,
      "familyName": (this.revisitData.familyName !== null && this.revisitData.familyName !== undefined) ? this.revisitData.familyName :  this.revisitData.lastName,
      "familyId": (this.revisitData.familyId !== null && this.revisitData.familyId !== undefined) ? this.revisitData.familyId : null,
      "beneficiaryName": benFullName,
      "benDistrictId" : (this.revisitData.i_bendemographics.districtID !== null && this.revisitData.i_bendemographics.districtID !== undefined) ? this.revisitData.i_bendemographics.districtID : null,
      "benBlockId" : (this.revisitData.i_bendemographics.blockID !== null && this.revisitData.i_bendemographics.blockID !== undefined) ? this.revisitData.i_bendemographics.blockID : null,
      "benVillageId":  (this.revisitData.i_bendemographics.districtBranchID !== null && this.revisitData.i_bendemographics.districtBranchID !== undefined) ? this.revisitData.i_bendemographics.districtBranchID : null,
