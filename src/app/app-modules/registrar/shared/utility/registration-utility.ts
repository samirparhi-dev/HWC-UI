...
export class RegistrationUtils {
  ...
  todayDate = this.currentDay + "-" + this.currentMonth + "-" + this.currentYear;
  ...
  **/
  ...
  createPersonalDetailsForm() {
    return this.fb.group({
      ...
      registrationDate: [{value:this.todayDate, disabled: true},[Validators.required]],
      age: null,
      ageUnit: null,
      ageAtMarriage: null,
      fingerprint: null,
