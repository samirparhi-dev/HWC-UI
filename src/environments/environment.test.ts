...
export const environment = {
  ...
  */
  ...
  getSwymedMailLoginUrl: `${TM_API}video_consultation/login/`,
  invokeSwymedCallUrl: `${TM_API}video_consultation/call/`,
  invokeSwymedCallSpecialistUrl: `${TM_API}video_consultation/callvan/`,
  getSwymedLogoutUrl: `${TM_API}video_consultation/logout`,
